    ...
    // (6 since 21 / 4 == 5, but 5 * 4 == 20 so you need 1 more for the 
    // purpose of this exercise), you will set the integers to 6 given 
    // values and then print out the character array both as a series of chars and as a string.
    ...
    int main() {
        ...
        union Char_int intCharacters = {{1853169737, 1936876900, 1684955508, 1768838432, 561213039, 0}};
